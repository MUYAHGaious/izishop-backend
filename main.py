...
app.include_router(casual_listings.router, prefix="/api/casual-listings", tags=["Casual Marketplace"])
app.include_router(transaction_fees.router, prefix="/api", tags=["Transaction Fees"])
